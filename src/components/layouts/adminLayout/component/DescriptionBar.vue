...
div.h-full(class='w-[250px] pt-6 px-4 overflow-auto !h-[calc(100vh-60px-24px)] pb-2')
  ...
  div.flex.flex-col.w-full.p-4.mt-2(v-if='roleUserId===3 || roleUserId===0' class='rounded-[10px] shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] cursor-pointer border border-white' @click='handleChangeManager("/manager/specialty")' :class='[{"!border-[#C52428]" : role==="specialty"}]')
    div.flex.justify-center
  ...
  div.flex.flex-col.w-full.p-4.mt-2(v-if='roleUserId===1' class='rounded-[10px] shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] cursor-pointer border border-white' @click='handleChangeManager("/manager/plan-doctor")' :class='[{"!border-[#C52428]" : role==="plan-doctor"}]')
    div.flex.justify-center
      img.w-10.h-10.shrink-0(src='../assets/plan.svg')
    div.text-center.font-bold(class='text-[18px] ') Quản lý kế hoạch khám bệnh(doctor)
  div.flex.flex-col.w-full.p-4.mt-2(v-if='roleUserId===1 || roleUserId===3' class='rounded-[10px] shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] cursor-pointer border border-white' @click='handleChangeManager("/manager/medicine")' :class='[{"!border-[#C52428]" : role==="medicine"}]')
    div.flex.justify-center
