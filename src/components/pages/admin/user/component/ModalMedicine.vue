...
div.overflow-y-auto
  ...
  div.flex.justify-end.gap-4.items-center.w-full.mt-4
    ...
    div.cursor-pointer.px-4.py-2.border(v-if='medicineEdit?.statusid===1 || !medicineEdit' class='font-bold text-sm rounded-[10px] border-[#DA151A] text-[#DA151A] hover:bg-[#DA151A] hover:text-white' @click="handleSave")
